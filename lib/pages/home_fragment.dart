...
class HomeFragment extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final topAnime = ref.watch(topAnimeControllerProv(const TopAnimeParams()));
    final animeNow = ref.watch(animeNowControllerProv(const AnimeNowParams()));
    return Scaffold(
      body: topAnime.when(
        data: (topAnimeDatum) {
          final datum = topAnimeDatum[0];
          final genres = datum.genres.map((genres) => genres.name).join(', ');

          return CustomSliiverAppBar(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: topAnime.when(data: (topAnimeDatum) {
                      return topAnimeDatum.isNotEmpty
                          ? MediaQuery.removePadding(
                              ...
                              child: ListView.separated(
                                ...
                                itemCount: topAnimeDatum.length,
                              ),
                            )
                          : Column(
                              children: [
                        ...
                        return animeNowDatum.isNotEmpty
                            ? MediaQuery.removePadding(
                                ...
                                child: ListView.separated(
                                    ...
                                    itemCount: animeNowDatum.length))
                            : Column(
                                children: [
                                  Icon(
                                    Icons.data_object_rounded,
