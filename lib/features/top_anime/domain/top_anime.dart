...
class TopAnimeResponse {
  ...
  factory TopAnimeResponse.fromJson(Map<String, dynamic> json) =>
      TopAnimeResponse(
        ...
        data: List<TopAnime>.from(json["data"].map((x) => TopAnime.fromJson(x))),
      );
...
class TopAnime {
  ...
  factory TopAnime.fromRawJson(String str) => TopAnime.fromJson(json.decode(str));
  ...
  factory TopAnime.fromJson(Map<String, dynamic> json) => TopAnime(
        ...
        type: TopAnimeTypeValues.map[json["type"]]!,
        source: json["source"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "type": TopAnimeTypeValues.reverse[type],
        "source": source,
        "episodes": episodes,
...
enum TopAnimeType { MOVIE, OVA, SPECIAL, TV }

final TopAnimeTypeValues = EnumValues({
  "Movie": TopAnimeType.MOVIE,
  "OVA": TopAnimeType.OVA,
  "Special": TopAnimeType.SPECIAL,
  "TV": TopAnimeType.TV
});
